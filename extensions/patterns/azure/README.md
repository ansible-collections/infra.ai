# Azure pattern for Ansible infra.ai collection

## Description

The pattern can provision or teardown RHEL AI on Azure.

## Usage

Pattern includes two playbooks:

- run_azure_provision.yml will provision infrastructure
- run_azure_teardown.yml will teardown infrustructure.
...
- SSH private key corresponding to `rhelai_azure_key_material`
- Azure inventory
- Azure credentials
...
- Controller job templates
  - RHEL Infra AI / Provision Azure
  - RHEL Infra AI / Teardown Azure
